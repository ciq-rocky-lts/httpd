...
# error: line 277: Invalid version (double separator '-'): 20120211-x86-64: Provides: httpd-mmn = 20120211, httpd-mmn = 20120211x8664, httpd-mmn = 20120211-x86-64
...
# CentOS bridge fixes.
Patch300: CVE-2006-20001.patch
Patch301: CVE-2020-35452.patch
Patch302: CVE-2021-26690.patch
Patch303: CVE-2022-22719.patch
Patch304: CVE-2022-22721.patch
Patch305: CVE-2022-23943.patch
...
%patch300 -p1 -b .cve20001
%patch301 -p1 -b .cve35452
%patch302 -p1 -b .cve26690
%patch303 -p1 -b .cve22719
%patch304 -p1 -b .cve22721
%patch305 -p1 -b .cve23943
...
%patch314 -p1 -b .cve39573
%patch315 -p1 -b .cve30522
%patch316 -p1 -b .cve47252
%patch317 -p1 -b .cve49812
...
%postun
# NOTE(neil): 2024-06-26 peridot import uses rpmbuild directly, which means the
# spec has to be valid for that version of RPM/macros--this is a deficiency.
%systemd_postun httpd.service htcacheclean.service
...
* Mon Nov 25 2024 Matt Hink <mhink@ciq.com> - 2.4.6-99.11
- CVE-2022-30522

* Fri Nov 22 2024 Matt Hink <mhink@ciq.com> - 2.4.6-99.10
- CVE-2024-39573
